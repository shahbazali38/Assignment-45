// Part 1
let guestArr : string[] = ["Jameel","Irfan","Adnan","Azeem"]
...
guestArr.map((items) =>
console.log(`${items} i have arranged a big dining table so i am inviting more guests.`));

// Part 2
let guestInStart : string = "Ali"
guestArr.unshift(guestInStart);
console.log(guestArr)

// Part 3
let middleguest : string = "Shaka"
